	...
	return (
		<>
			<div className='h-[100vh]'>
				...
				<div className='absolute top-[320px] flex flex-col justify-center  text-white font-semibold w-full text-center text-4xl sm:text-3xl md:text-4xl lg:text-5xl 2xl:text-6xl 3xl:text-7xl gap-8'>
					<h1
						data-aos='fade-up'
						data-aos-offset='0'
